...
For instance, a data file in the ISEE-1 plasma wave spectrum analyzer dataset in the SPDF's archive is at  
...
Reprocessing version; preferably uses a format of "vNN" where NN=01, 02, 03, etc. Some projects use a more complicated versioning scheme, such as Release, Major, Minor (v02.13.004). (Metadata dictionary names: ISTP: "Data_version", SPASE: "")
