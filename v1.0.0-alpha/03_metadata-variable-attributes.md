...
| [REFERENCE_POSITION](#Reference_Position)       | Optional                                             |    { "data" }          | Topocenter (local), Geocenter, rotating Earth geoid (used by CDF_TIME_TT2000)                                                                                                             |
 | [RELATIVE_ERROR](#Relative_Error)               | Optional                                             |   { "deg" }          | Relative or random error, in same 
units as Units attribute - to specify the accuracy of the time stamps relative to each other.                                                         |
