...
| ----------------------------------------- | ---------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------- |
| [CATDESC](#CATDESC)                       | Required                     |{ "HET Default time" }| Required for all variables                                                                                                              |
...
| [DEPEND_3](#DEPEND_3)                     | Required                     |                                                                       | Data of the following form:  3D spectrogram                                                                                            |
| [DISPLAY_TYPE](#DISPLAY_TYPE)             | Required                     | { "time_series" }                                                    | Data                                                                                                                                    |
| [FIELDNAM](#FIELDNAM)                     | Required                     | { "HET_A_H_Rate_TS" }                             | All                                                                                                                                     |
...
| [VAR_TYPE](#VAR_TYPE)                     | Required                     |      { "support_data" }                                                                  | All                                                                                                                                     |
...
| [VAR_NOTES](#VAR_NOTES)                   | Recommended                  |    { "Epoch is midpoint of integration." }                                                                    | All                                                                                                                                     |
...
| [DICT_KEY](#DICT_KEY)                     | Optional                     |            { "time" }                                                           | All                                                                                                                                     |
