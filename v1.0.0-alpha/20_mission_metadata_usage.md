...
1.1 Required-
   ...
   1.1.1  Data_type-
    ...
    1.1.2 Data_version- This attribute identifies the version (vX.Y.Z) of a particular CDF data file.
   
    1.1.3 Descriptor- This attribute identifies the name of the instrument or sensor that collected the data. Both a long name and a short name are given. For any data file, only a single value is allowed. For MMS, the following are valid values:
