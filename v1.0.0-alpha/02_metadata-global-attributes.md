...
| [Logical_file_id](#Logical_file_id)                       | Required                     | { "GE_K0_EPI_19920908_V01" }.                            | Stores the name of the CDF file using the ISTP naming convention (source_name/data_type/ descriptor/date/data_version), *e.g.,* psp_isois_l2-summary_00000000_v01.cdf.                                                                                                                                                                                        |
...
| [Acknowledgment](#acknowledgement)                                 | Recommended                  |                                                          | Text string at Particles and Ion (PI) disposal allowing for information on expected acknowledgment if data is citable.                                                                                                                                                                                                                         |
...
| [Rules_of_use](#Rules_of_use)                                    | Recommended                  |                                                          | Text containing information on, {\it e.g.} citability and PI access restrictions. This may point to a World Wide Web page specifying the rules of use.                                                                                                                                                                                         |
...
| [Software_version](#Software_version)                             | Optional                     |                                                          | Required attribute for Cluster, but for Inter-Agency Consultative Group (IACG) purposes it exists if experimenters want to track it.                                                                                                                                                                                                           |
